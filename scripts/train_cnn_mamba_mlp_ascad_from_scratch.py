...
DEFAULT_CHECKPOINT_DIRECTORY = (
    PROJECT_ROOT
    / "checkpoints/cnn_mamba_mlp_ascad/from_scratch"
)
...
class TrainingConfig:
    """Configuration for CNN-Mamba-MLP training from scratch."""
...
def validate_config(config: TrainingConfig) -> None:
    """Validate the from-scratch training configuration."""
    if config.epochs <= 0:
...
def save_checkpoint(
    ...
    *,
    ...
    """Save the complete from-scratch training state."""
    ...
    checkpoint = {
        "training_experiment": "from_scratch",
        "epoch": epoch,
...
def resume_training(
    ...
    if checkpoint_mapping.get("training_experiment") != "from_scratch":
        raise ValueError(
            "The resume checkpoint is not a from-scratch checkpoint."
        )
...
def main() -> None:
    """Train CNN-Mamba-MLP from random initialization."""
    ...
    print()
    print("CNN-Mamba-MLP ASCAD training from scratch")
    print("-----------------------------------------")
