...
def load_model(
    ...
    """Load a trained Mamba-CNN checkpoint."""
...
def save_guessing_entropy_plot(
    ...
    plt.title("Mamba-CNN ASCAD - Guessing Entropy")
    plt.grid(True)
    plt.legend()
    plt.tight_layout()
...
def save_success_rate_plot(
    ...
    plt.title("Mamba-CNN ASCAD - Success Rate")
    plt.ylim(-0.02, 1.02)
    plt.grid(True)
    plt.legend()
    plt.tight_layout()
...
def parse_arguments() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Evaluate a trained Mamba-CNN model on the ASCAD attack traces."
        )
    )
    parser.add_argument(
        "--dataset",
    ...
    parser.add_argument(
        "--checkpoint",
        type=Path,
        default=Path("checkpoints/mamba_cnn_ascad/phase_4/best_model.pt"),
        help="Trained Mamba-CNN checkpoint."
    )
    ...
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=Path("results/mamba_cnn_ascad/phase_4"),
...
def main() -> None:
    ...
    print("=" * 70)
    print("MAMBA-CNN ASCAD ATTACK EVALUATION")
    print("=" * 70)
